...
fun FormInputSiswa(
    ...
    Column(
        ...
        OutlinedTextField(value = detailSiswa.deskripsi,
            onValueChange = {onValueChange(detailSiswa.copy(deskripsi = it))},
            label = { Text(stringResource(id = R.string.deskripsi1))},
            modifier = Modifier.fillMaxWidth(),
            enabled = enabled,
            singleLine = true
        )
